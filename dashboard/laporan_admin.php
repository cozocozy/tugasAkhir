...
//ambil data tabel
$query =("SELECT * FROM t_transaksi JOIN t_pembayaran ON t_transaksi.id_pembayaran = t_pembayaran.id_pembayaran");
...
move_uploaded_file($temp3, $dir3.$newFile3);
  //ubah data
  $query = "UPDATE t_transaksi SET bukti_invoice='$newFile1',bukti_kurir='$newFile2',surat_jalan='$newFile3' WHERE id_transaksi= $id";
  $result = mysqli_query($conn,$query);
  if (!$result) 
...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <!-- main -->
    <div class="text-center text-lg mt-5 mb-5"><b>BUKTI SURAT-SURAT SARANA HASIL MANDIRI</b></div>
                                              ...
                                              <div aria-hidden="true"><i class="fas fa-times fa-lg"></i></div>
                                                  ...
                                                  <div class="modal-body font-weight-bold">
                                                    <form action="" method="post" enctype="multipart/form-data">
                                                          ...
                                                          <div class="form-group text-left">
                                                              <label>Bukti Invoice</label>
                                                              <input type="file" class="form-control" name="bukti1" required>
                                                          </div>
                                                          <div class="form-group text-left">
                                                              <label>Bukti Kurir</label>
                                                              <input type="file" class="form-control" name="bukti2" required>
                                                          </div>
                                                          <div class="form-group text-left">
                                                              <label>Surat Jalan</label>
                                                              <input type="file" class="form-control" name="bukti3" required>
                                                          </div>
