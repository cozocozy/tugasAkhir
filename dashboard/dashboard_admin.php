  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <!-- informasi harga -->
              <div class="col-xl-2 col-xl-2 ml-5 mr-3 mt-3" >
                  <a href="informasi_harga_admin.php" style="text-decoration:none">
              ...
              <!-- pemesanan -->
              <div class="col-xl-2 col-xl-2 ml-4 mr-3 mt-3 ">
                <a href="pemesanan_admin.php" style="text-decoration:none">
              ...
              <!-- pembayaran -->
              <div class="col-xl-2 col-xl-2 ml-4 mr-3 mt-3">
              <a href="http://localhost:8080/sarana_mandiri/dashboard/pembayaran_admin.php" style="text-decoration:none">
      ...
      <!-- End of Content Wrapper -->
              <!-- surat-surat -->
            <div class="col-xl-2 col-xl-2 mr-3 ml-4 mt-3">
              <a href="http://localhost:8080/sarana_mandiri/dashboard/laporan_admin.php" style="text-decoration:none">
                <div class="card border-left-secondary shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-lg font-weight-bold text-secondary text-uppercase mt-2 ml-3">Surat-Surat</div>
                      </div>
                      <div class="col-auto">
                      <i class="fas fa-file fa-2x text-300 mr-3" style="color:#757575;"> </i>
                     </div>
                    </div>
                  </div>
                </div>
      ...
      <!-- End of Content Wrapper -->
                    ...
                    <!-- Laporan -->
                    <div class="col-xl-2 col-xl-2 ml-4 mr-3 mt-3">
              <a href="http://localhost:8080/sarana_mandiri/dashboard/laporan.php" style="text-decoration:none">
                <div class="card border-left-info shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-lg font-weight-bold text-info text-uppercase mt-2 ml-3">Laporan</div>
                      </div>
                      <div class="col-auto">
