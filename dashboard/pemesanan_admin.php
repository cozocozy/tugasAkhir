...
//ambil data tabel
$query =("SELECT * FROM t_pemesanan JOIN t_harga ON t_pemesanan.id_harga = t_harga.id_harga");
                                    ...
                                    <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                                      ...
                                      <td class="align-middle"><?= $row["no_pemesanan"]; ?></td>
                                       <td class="align-middle"><?= $row["paket"]; ?></td>
                                        ...
                                        <td><a href="?id=<?= $row['id_pemesanan']; ?>" class="btn btn-info ml-1 mr-1" data-toggle="modal" data-target="#rinciModal<?= $row["id_pemesanan"]; ?>">Rincian</a>
